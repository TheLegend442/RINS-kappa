...
#ifndef DIS_TUTORIAL1__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
#define DIS_TUTORIAL1__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
 ...
 * calls
 * dis_tutorial1__srv__AddTwoInts_Request__init().
...
/**
 * It calls
 * dis_tutorial1__srv__AddTwoInts_Request__fini()
 ...
 * dis_tutorial1__srv__AddTwoInts_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dis_tutorial1__srv__AddTwoInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dis_tutorial1__srv__AddTwoInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dis_tutorial1
...
/**
 * It calls
 * dis_tutorial1__srv__AddTwoInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dis_tutorial1
...
/**
 * It allocates the memory for the array and calls
 * dis_tutorial1__srv__AddTwoInts_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dis_tutorial1
...
/**
 * It calls
 * dis_tutorial1__srv__AddTwoInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DIS_TUTORIAL1__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
