...
static rosidl_typesupport_introspection_c__MessageMember custom_messages__msg__RingCoordinates__rosidl_typesupport_introspection_c__RingCoordinates_message_member_array[1] = {
  {
    "center",  // name
