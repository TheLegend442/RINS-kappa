...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RingCoordinates_message_member_array[3] = {
  {
    "center",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::RingCoordinates, strength),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
