...
class RingDetector(Node):
    ...
    def image_callback(self, data):
        ...
        # plot a horizontal line on acopy of the image
        cv_image_copy = cv_image.copy()
        cv2.line(cv_image_copy, (0, 200), (cv_image.shape[1], 200), (255, 0, 0), 2)
        cv2.text(cv_image_copy, f"Height x width: {cv_image.shape[1]} x {cv_image.shape[0]}", (0, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)

        cv2.imshow("Live feed", cv_image_copy)
        cv2.waitKey(1)
