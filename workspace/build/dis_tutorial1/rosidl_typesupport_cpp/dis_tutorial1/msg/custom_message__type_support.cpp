...
static const _CustomMessage_type_support_symbol_names_t _CustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dis_tutorial1, msg, CustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dis_tutorial1, msg, CustomMessage)),
  }
};
...
{
  return &::dis_tutorial1::msg::rosidl_typesupport_cpp::CustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dis_tutorial1, msg, CustomMessage)() {
  return get_message_type_support_handle<dis_tutorial1::msg::CustomMessage>();
}
