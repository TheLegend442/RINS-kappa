...
static rosidl_typesupport_introspection_c__MessageMember custom_messages__msg__RingCoordinates__rosidl_typesupport_introspection_c__RingCoordinates_message_member_array[3] = {
  {
    "center",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages__msg__RingCoordinates, strength),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
