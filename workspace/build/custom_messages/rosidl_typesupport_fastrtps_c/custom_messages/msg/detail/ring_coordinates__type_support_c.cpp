...
#include "custom_messages/msg/detail/ring_coordinates__rosidl_typesupport_fastrtps_c.h"
...
#include "visualization_msgs/msg/detail/marker__functions.h"  // center
...
using _RingCoordinates__ros_msg_type = custom_messages__msg__RingCoordinates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RingCoordinates__ros_msg_type * ros_message = static_cast<const _RingCoordinates__ros_msg_type *>(untyped_ros_message);
  // Field name: center
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RingCoordinates__ros_msg_type * ros_message = static_cast<_RingCoordinates__ros_msg_type *>(untyped_ros_message);
  // Field name: center
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_messages__msg__RingCoordinates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RingCoordinates__ros_msg_type * ros_message = static_cast<const _RingCoordinates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RingCoordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__RingCoordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__RingCoordinates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__RingCoordinates;
    is_plain =
      (
...
static size_t _RingCoordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__RingCoordinates(
...
static message_type_support_callbacks_t __callbacks_RingCoordinates = {
  "custom_messages::msg",
  "RingCoordinates",
...
static rosidl_message_type_support_t _RingCoordinates__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RingCoordinates,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, RingCoordinates)() {
  return &_RingCoordinates__type_support;
}
