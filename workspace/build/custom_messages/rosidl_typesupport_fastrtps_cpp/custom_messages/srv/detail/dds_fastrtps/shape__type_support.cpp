...
// functions for custom_messages::srv::Shape_Request already declared above

// functions for custom_messages::srv::Shape_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_messages
cdr_serialize(
  const custom_messages::srv::Shape_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      custom_messages::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::srv::Shape_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      custom_messages::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_messages::srv::typesupport_fastrtps_cpp::get_serialized_size(
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_messages
max_serialized_size_Shape_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_messages::srv::typesupport_fastrtps_cpp::max_serialized_size_Shape_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_messages::srv::typesupport_fastrtps_cpp::max_serialized_size_Shape_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_messages::srv::Shape_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::srv::Shape_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_messages::srv::Shape_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Shape_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_messages::srv::Shape_Event *>(
...
static size_t _Shape_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Shape_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Shape_Event__callbacks = {
  "custom_messages::srv",
  "Shape_Event",
...
static rosidl_message_type_support_t _Shape_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Shape_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Shape_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, Shape_Event)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Shape_Event__handle;
}
...
static const rosidl_service_type_support_t _Shape__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Shape__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_messages::srv::Shape_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_messages::srv::Shape_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_messages::srv::Shape_Event>(),
