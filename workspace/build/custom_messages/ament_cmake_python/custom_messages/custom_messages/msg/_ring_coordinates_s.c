...
bool custom_messages__msg__ring_coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._ring_coordinates.RingCoordinates", full_classname_dest, 53) == 0);
  }
  custom_messages__msg__RingCoordinates * ros_message = _ros_message;
  {  // center
  ...
  {  // strength
    ...
    ros_message->strength = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of RingCoordinates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._ring_coordinates");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RingCoordinates");
