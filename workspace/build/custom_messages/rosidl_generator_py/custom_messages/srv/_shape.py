...
class Metaclass_Shape_Event(type):
    """Metaclass of message 'Shape_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__shape__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__shape__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__shape__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__shape__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__shape__event
...
class Shape_Event(metaclass=Metaclass_Shape_Event):
    """Message class 'Shape_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_messages/Shape_Request, 1>',
        'response': 'sequence<custom_messages/Shape_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_messages', 'srv'], 'Shape_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_messages', 'srv'], 'Shape_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_messages.srv import Shape_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Shape_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Shape_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_messages.srv import Shape_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Shape_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Shape_Response'"
...
class Metaclass_Shape(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _shape.Metaclass_Shape_Event._TYPE_SUPPORT is None:
                _shape.Metaclass_Shape_Event.__import_type_support__()
...
class Shape(metaclass=Metaclass_Shape):
    ...
    from custom_messages.srv._shape import Shape_Event as Event
