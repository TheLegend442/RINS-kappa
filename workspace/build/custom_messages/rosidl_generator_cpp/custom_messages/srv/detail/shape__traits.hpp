...
inline std::string to_yaml(const Shape_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use custom_messages::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const custom_messages::srv::Shape_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  custom_messages::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use custom_messages::srv::to_yaml() instead")]]
inline std::string to_yaml(const custom_messages::srv::Shape_Event & msg)
{
  return custom_messages::srv::to_yaml(msg);
}

template<>
inline const char * data_type<custom_messages::srv::Shape_Event>()
{
  return "custom_messages::srv::Shape_Event";
}

template<>
inline const char * name<custom_messages::srv::Shape_Event>()
{
  return "custom_messages/srv/Shape_Event";
}

template<>
struct has_fixed_size<custom_messages::srv::Shape_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<custom_messages::srv::Shape_Event>
  : std::integral_constant<bool, has_bounded_size<custom_messages::srv::Shape_Request>::value && has_bounded_size<custom_messages::srv::Shape_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<custom_messages::srv::Shape_Event>
  : std::true_type {};
