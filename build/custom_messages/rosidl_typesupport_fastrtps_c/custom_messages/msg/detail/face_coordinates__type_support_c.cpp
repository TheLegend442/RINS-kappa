...
#include "custom_messages/msg/detail/face_coordinates__rosidl_typesupport_fastrtps_c.h"
...
#include "visualization_msgs/msg/detail/marker__functions.h"  // bottom_right, center, upper_left
...
using _FaceCoordinates__ros_msg_type = custom_messages__msg__FaceCoordinates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FaceCoordinates__ros_msg_type * ros_message = static_cast<const _FaceCoordinates__ros_msg_type *>(untyped_ros_message);
  // Field name: center
  {
  ...
  void * untyped_ros_message)
{
  ...
  _FaceCoordinates__ros_msg_type * ros_message = static_cast<_FaceCoordinates__ros_msg_type *>(untyped_ros_message);
  // Field name: center
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_messages__msg__FaceCoordinates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceCoordinates__ros_msg_type * ros_message = static_cast<const _FaceCoordinates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FaceCoordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__FaceCoordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__FaceCoordinates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__FaceCoordinates;
    is_plain =
      (
...
static size_t _FaceCoordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__FaceCoordinates(
...
static message_type_support_callbacks_t __callbacks_FaceCoordinates = {
  "custom_messages::msg",
  "FaceCoordinates",
...
static rosidl_message_type_support_t _FaceCoordinates__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FaceCoordinates,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, FaceCoordinates)() {
  return &_FaceCoordinates__type_support;
}
